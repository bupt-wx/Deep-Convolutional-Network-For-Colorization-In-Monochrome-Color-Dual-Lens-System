...
def trainSceneFlowData(hp, tp, up, env, callbacks, upw):
        ...
        left_root = frank_root_path + '/color_0_ycbcr'
        right_root = frank_root_path + '/color_1_ycbcr'
        ...
        model.compile(optimizer = optimizer, loss = loss, metrics = [coloringLoss_OneAccuracyYUV, coloringLoss_ThreeAccuracyYUV])
